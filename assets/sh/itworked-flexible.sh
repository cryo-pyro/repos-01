...
read -p "📦  GitHub Repo Name (e.g. strata-twin)       : " REPO_NAME
read -p "🚀  Render Service Name (e.g. strata-twin-v0) : " RENDER_NAME
#         ↑ Render names are GLOBAL — must be unique across all Render users.
#           If 'strata-twin' is taken, try 'strata-twin-v0', 'strata-twin-kd', etc.
...
echo "    Render prefix: ${RENDER_NAME}  →  ${RENDER_NAME}-api  /  ${RENDER_NAME}-ui"
echo ""
...
# ── STEP 6: RENDER YAML — uses RENDER_NAME (globally unique) ─────
# REPO_NAME  = your GitHub repo  (only needs to be unique in YOUR account)
# RENDER_NAME = your Render service prefix (must be unique across ALL Render users)
cat <<EOF > render.yaml
services:
  - type: web
    name: ${RENDER_NAME}-api
    env: python
  ...
  - type: static
    ...
    envVars:
      - key: REACT_APP_API_URL
        value: https://${RENDER_NAME}-api.onrender.com
EOF
...
echo "     Service name  : ${RENDER_NAME}-api        ← must be globally unique"
...
echo "     Repo          : ${GH_USER}/${REPO_NAME}"
echo "     Service name  : ${RENDER_NAME}-ui         ← must be globally unique"
echo "     Root Dir      : frontend"
echo "     Build Command : npm install && npm run build"
echo "     Publish Dir   : build"
echo "     Env var       : REACT_APP_API_URL=https://${RENDER_NAME}-api.onrender.com"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  YOUR URLS (live after Render finishes ~3 min):"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  API check  : https://${RENDER_NAME}-api.onrender.com"
echo "               → should show: { status: Twin Active, variables: 93 }"
echo ""
echo "  Main app   : https://${RENDER_NAME}-ui.onrender.com"
echo "               📊 Overview · 💧 Leakage · 🔬 Diagnosis · 🧊 Tensor"
echo "               📋 Operations (all 93 variables) · 📤 Upload CSV"
echo ""
echo "  Geo map    : https://${RENDER_NAME}-ui.onrender.com/ops-geo.html"
